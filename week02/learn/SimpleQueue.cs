public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Removing data from index 1 rather than index 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enque inserting at front of queue
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //need to add to the end of the queue
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //list starts at index 0
        _queue.RemoveAt(0);
        return value;
    }
}